    ...
    onPrepare: function () {
        ...
        browser.driver.wait(function () {
            return browser.driver.getCurrentUrl().then(function (url) {
                ...
                browser.driver.findElement(by.id('in_WEBRPTS')).click();
                browser.driver.findElement(by.xpath("//div[@id='ExternalLogin?form_action=external_login&url=http://localhost:8080/ccii/sso_sub']/div")).click();

                return true;
            });
        }, 5000);

        browser.driver.switchTo().frame("internal_iframe");

        browser.driver.wait(function() {

            return browser.driver.isElementPresent(by.css('h2'));
        }, 5000);
