...
define(['scripts/teacher/controllers/classMgmt/StudentReadCtrl'],
    function (targetCtrl) {

        describe('Class Mgmt - Student Read Controller Test', function () {
            var scope,
                configMock,
                serviceMock,
                stateMock,
             ...
             */
            it('scope model classMgmtStudentReadInit to be true', function () {
                expect(scope.model.classMgmtStudentReadInit).toBeTruthy();
            });
