...
define(['scripts/teacher/controllers/classMgmt/StudentCreateCtrl'],
    function (targetCtrl) {

        describe('Class Mgmt - Student Create Controller Test', function () {
            var scope,
                configMock,
                serviceMock,
                stateMock,
             ...
             */
            it('scope model classMgmtStudentWriteInit to be true', function () {
                expect(scope.model.classMgmtStudentWriteInit).toBeTruthy();
            });
